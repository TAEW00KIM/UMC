...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -1230358833L;
    ...
    public final com.taewoo.study.domain.QMember member;

    public final com.taewoo.study.domain.QMission mission;

    public final EnumPath<com.taewoo.study.domain.enums.MissionStatus> status = createEnum("status", com.taewoo.study.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.taewoo.study.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new com.taewoo.study.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
